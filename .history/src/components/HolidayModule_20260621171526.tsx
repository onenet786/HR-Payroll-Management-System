                  ...
                  <div key={holiday.id} className="flex items-center justify-between px-4 py-3 hover:bg-slate-700/20 transition group">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          {holiday.isRecurring && (
                            <RefreshCw size={11} className="text-slate-400" title="Recurring annually" />
                          )}
                        </div>
                        {holiday.description && (
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button onClick={() => openEdit(holiday)}
                        className="opacity-0 group-hover:opacity-100 p-1.5 rounded-lg text-slate-400 hover:text-blue-400 hover:bg-blue-500/10 transition">
                        <Edit2 size={13} />
                      </button>
