            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label htmlFor="loan-type" className="block text-[10px] font-bold text-slate-400 uppercase tracking-w
                    <select value={form.type} onChange={e => setForm(p => ({ ...p, type: e.target.value as LoanAdvance['type'] }))}
                      className="w-full bg-slate-800 border border-slate-700 text-white text-sm rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-emerald-500">
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Amount (PKR)</label>
                    <input type="number" min="1000" step="1000" value={form.principalAmount}
